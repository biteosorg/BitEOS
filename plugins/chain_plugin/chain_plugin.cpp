...
static fc::variant get_global_row( const database& db, const abi_def& abi, const abi_serializer& abis, const fc::microseconds& abi_serializer_max_time_ms ) {
   ...
   const auto* const table_id = db.find<chain::table_id_object, chain::by_code_scope_table>(boost::make_tuple(N(besio), N(besio), N(global)));
...
read_only::get_producers_result read_only::get_producers( const read_only::get_producers_params& p ) const {
   const abi_def abi = besio::chain_apis::get_abi(db, N(besio));
   ...
   const auto* const table_id = d.find<chain::table_id_object, chain::by_code_scope_table>(boost::make_tuple(N(besio), N(besio), N(producers)));
   const auto* const secondary_table_id = d.find<chain::table_id_object, chain::by_code_scope_table>(boost::make_tuple(N(besio), N(besio), N(producers) | secondary_index_num));
...
read_only::get_account_results read_only::get_account( const get_account_params& params )const {
   ...
   const auto& code_account = db.db().get<account_object,by_name>( N(besio) );
