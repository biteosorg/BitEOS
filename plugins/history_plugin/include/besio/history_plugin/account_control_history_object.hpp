...
CHAINBASE_SET_INDEX_TYPE( besio::account_control_history_object, besio::account_control_history_multi_index )

FC_REFLECT( besio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
