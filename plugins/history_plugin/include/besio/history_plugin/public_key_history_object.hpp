...
CHAINBASE_SET_INDEX_TYPE( besio::public_key_history_object, besio::public_key_history_multi_index )

FC_REFLECT( besio::public_key_history_object, (public_key)(name)(permission) )
