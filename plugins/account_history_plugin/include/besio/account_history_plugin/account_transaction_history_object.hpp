...
namespace std {
   ...
   template<>
   struct hash<besio::chain::account_name>
   {
    size_t operator()( const besio::chain::account_name& name )const
    {
...
CHAINBASE_SET_INDEX_TYPE( besio::account_transaction_history_object, besio::account_transaction_history_multi_index )

FC_REFLECT( besio::account_transaction_history_object, (name)(transaction_id) )
