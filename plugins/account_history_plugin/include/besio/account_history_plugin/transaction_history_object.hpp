...
CHAINBASE_SET_INDEX_TYPE( besio::transaction_history_object, besio::transaction_history_multi_index )

FC_REFLECT( besio::transaction_history_object, (block_id)(transaction_id)(transaction_status) )
