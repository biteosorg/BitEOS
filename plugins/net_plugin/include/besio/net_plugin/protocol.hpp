...
FC_REFLECT( besio::select_ids<fc::sha256>, (mode)(pending)(ids) )
FC_REFLECT( besio::chain_size_message,
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id))
FC_REFLECT( besio::handshake_message,
            (network_version)(chain_id)(node_id)(key)
            (time)(token)(sig)(p2p_address)
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id)
            (os)(agent)(generation) )
FC_REFLECT( besio::go_away_message, (reason)(node_id) )
FC_REFLECT( besio::time_message, (org)(rec)(xmt)(dst) )
FC_REFLECT( besio::notice_message, (known_trx)(known_blocks) )
FC_REFLECT( besio::request_message, (req_trx)(req_blocks) )
FC_REFLECT( besio::sync_request_message, (start_block)(end_block) )
