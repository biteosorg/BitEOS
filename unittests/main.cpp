...
//extern uint32_t BES_TESTING_GENESIS_TIMESTAMP;
...
boost::unit_test::test_suite* init_unit_test_suite(int argc, char* argv[]) {
   ...
   /*
   const char* genesis_timestamp_str = getenv("BES_TESTING_GENESIS_TIMESTAMP");
   if( genesis_timestamp_str != nullptr )
   {
      BES_TESTING_GENESIS_TIMESTAMP = std::stoul( genesis_timestamp_str );
   }
   std::cout << "BES_TESTING_GENESIS_TIMESTAMP is " << BES_TESTING_GENESIS_TIMESTAMP << std::endl;
   */
   return nullptr;
}
