...
namespace tic_tac_toe {
   ...
   struct game {
      ...
      BESLIB_SERIALIZE( game, (challenger)(host)(turn)(winner)(board) )
   };
   ...
   struct create {
      ...
      BESLIB_SERIALIZE( create, (challenger)(host) )
   };
   ...
   struct restart {
      ...
      BESLIB_SERIALIZE( restart, (challenger)(host)(by) )
   };
   ...
   struct close {
      ...
      BESLIB_SERIALIZE( close, (challenger)(host) )
   };
   ...
   struct movement {
      ...
      BESLIB_SERIALIZE( movement, (row)(column) )
   };
   ...
   struct move {
      ...
      BESLIB_SERIALIZE( move, (challenger)(host)(by)(mvt) )
   };

   /**
    * @brief table definition, used to store existing games and their current state
    */
   typedef besio::multi_index< games_account, game> games;
}
/// @}
