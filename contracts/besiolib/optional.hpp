   ...
   class optional {
      public:
         ...
         */
          ...
          */
         T&       operator*()      { besio_assert(_valid, "dereference of empty optional"); return ref(); }
          ...
          * @return T& - Contained value
          */
         const T& operator*()const { besio_assert(_valid, "dereference of empty optional"); return ref(); }
         ...
         T*       operator->()
         {
            besio_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         *  @return besio::datastream<Stream>& - Reference to the datastream
         */
         template<typename Stream>
         friend inline besio::datastream<Stream>& operator>> (besio::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         */
         template<typename Stream>
         friend inline besio::datastream<Stream>& operator<< (besio::datastream<Stream>& ds, const optional& op)
         {
