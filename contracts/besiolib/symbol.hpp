#pragma once
#include <besiolib/core_symbol.hpp>
...
namespace besio {
   ...
   */
    ...
    * @param str - the string representation of the symbol
    */
   #define S(P,X) ::besio::string_to_symbol(P,#X)
   ...
   struct symbol_type {
      ...
      */
      ...
      BESLIB_SERIALIZE( symbol_type, (value) )
   };
   ...
   struct extended_symbol : public symbol_type
   {
     ...
     extended_symbol( symbol_name sym = 0, account_name acc = 0 ):symbol_type{sym},contract(acc){}
      ...
      BESLIB_SERIALIZE( extended_symbol, (value)(contract) )
   };
