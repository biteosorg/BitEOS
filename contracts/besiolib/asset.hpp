...
namespace besio {
   ...
   struct asset {
      ...
      asset& operator*=( int64_t a ) {
         besio_assert( a == 0 || (amount * a) / a == amount, "multiplication overflow or underflow" );
         besio_assert( -max_amount <= amount, "multiplication underflow" );
         besio_assert( amount <= max_amount,  "multiplication overflow" );
         amount *= a;
         return *this;
      }
