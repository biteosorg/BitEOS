 ...
 * @ingroup types
 * @brief Defines contract type which is %base class for every BESIO contract
 * 
 * @{
 * 
 */
...
/**
 * @brief %Base class for BESIO contract.
 * @details %Base class for BESIO contract. %A new contract should derive from this class, so it can make use of BESIO_ABI macro.
 */
class contract {
   public:
      /**
