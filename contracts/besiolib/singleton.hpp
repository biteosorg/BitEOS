...
namespace  besio {
    ...
    *  @brief Defines BESIO Singleton Table
    *  @ingroup databasecpp 
    *  @{
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         BESLIB_SERIALIZE( row, (value) )
      };

      typedef besio::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            besio_assert( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
