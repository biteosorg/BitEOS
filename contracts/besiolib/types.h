 ...
 * @details BESIO Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
...
/**
 * @brief BESIO Signature
 * @details BESIO Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of BESIO Transaction Id
 * @details Type of BESIO Transaction Id. It is 256-bit hash
 */
