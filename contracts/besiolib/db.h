 ...
 *  @brief Defines an interface to BESIO database
 *  @ingroup database
 *
 *  @details
 *  BESIO organizes data according to the following broad structure:
 ...
 *  @ingroup database
 *
 *  @details Database C API provides low level interface to BESIO database.
 *
...
/**
  ...
  *  besio_assert(itr >= 0, "Alice cannot be removed since she was already not found in the table");
  *  db_remove_i64(itr);
  *  @endcode
  */
...
/**
  ...
  *  besio_assert(len <= 50, "buffer to small to store retrieved record");
...
/**
  ...
  *  besio_assert(end_itr < -1, "Charlie was not the last entry in the table");
  *  @endcode
  */
