...
#ifdef DISABLE_BESLIB_SERIALIZE
#include <besiolib/serialize.hpp>
#undef BESLIB_SERIALIZE
#define BESLIB_SERIALIZE(...)
#endif
...
struct u128_action {
  ...
  BESLIB_SERIALIZE( u128_action, (values) )
};
...
struct cf_action {
   ...
   BESLIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   BESLIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   BESLIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};
