...
namespace besio {
   ...
   struct margin_state {
      ...
      extended_asset unlend( double ishares ) {
         ...
         besio_assert( interest_shares >= 0, "underflow" );
         besio_assert( total_lendable.amount >= 0, "underflow" );

         return result;
      }

      BESLIB_SERIALIZE( margin_state, (total_lendable)(total_lent)(least_collateralized)(interest_shares) )
   };
   ...
   struct exchange_state {
      ...
      struct connector {
         ...
         BESLIB_SERIALIZE( connector, (balance)(weight)(peer_margin) )
      };
      ...
      BESLIB_SERIALIZE( exchange_state, (manager)(supply)(fee)(base)(quote) )
   };

   typedef besio::multi_index<N(markets), exchange_state> markets;
