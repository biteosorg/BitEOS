/**
 *  @file
 *  @copyright defined in besio/LICENSE.txt
 */
...
{
   try {
      app().set_version(besio::nodbes::config::version);
      app().register_plugin<history_plugin>();

      auto root = fc::app_path();
      app().set_default_data_dir(root / "besio/nodbes/data" );
      app().set_default_config_dir(root / "besio/nodbes/config" );
