...
CHAINBASE_SET_INDEX_TYPE(besio::chain::permission_object, besio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(besio::chain::permission_usage_object, besio::chain::permission_usage_index)

FC_REFLECT(chainbase::oid<besio::chain::permission_object>, (_id))
FC_REFLECT(besio::chain::permission_object, (id)(usage_id)(parent)(owner)(name)(last_updated)(auth))

FC_REFLECT(chainbase::oid<besio::chain::permission_usage_object>, (_id))
FC_REFLECT(besio::chain::permission_usage_object, (id)(last_used))
