...
FC_REFLECT(besio::chain::memory_db::account_info, (name)(available))
FC_REFLECT(besio::chain::memory_db::bp_info, (name)(producer_key)
  (commission_rate)(total_staked)(rewards_pool)(total_voteage)(voteage_update_height)(url)(emergency))
FC_REFLECT(besio::chain::memory_db::chain_status, (name)(emergency))
