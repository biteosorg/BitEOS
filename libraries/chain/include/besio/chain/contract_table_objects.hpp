...
#include <besio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(besio::chain::table_id_object, besio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(besio::chain::key_value_object, besio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(besio::chain::index64_object, besio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(besio::chain::index128_object, besio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(besio::chain::index256_object, besio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(besio::chain::index_double_object, besio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(besio::chain::index_long_double_object, besio::chain::index_long_double_index)

FC_REFLECT(besio::chain::table_id_object, (id)(code)(scope)(table) )
FC_REFLECT(besio::chain::key_value_object, (id)(t_id)(primary_key)(value)(payer) )
