...
FC_REFLECT_DERIVED( besio::chain::deferred_transaction, (besio::chain::signed_transaction), (sender_id)(sender)(payer)(execute_after) )
FC_REFLECT( besio::chain::deferred_reference, (sender)(sender_id) )
