...
namespace fc {
inline void to_variant(const besio::chain::asset& var, fc::variant& vo) { vo = var.to_string(); }
inline void from_variant(const fc::variant& var, besio::chain::asset& vo) {
   vo = besio::chain::asset::from_string(var.get_string());
}
}

FC_REFLECT(besio::chain::asset, (amount)(sym))
FC_REFLECT(besio::chain::extended_asset, (quantity)(contract) )
