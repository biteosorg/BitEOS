...
FC_REFLECT( besio::chain::tmp_transfer, (from)(to)(quantity)(memo) )
FC_REFLECT( besio::chain::tmp_issue, (to)(quantity)(memo) )
FC_REFLECT( besio::chain::tmp_vote, (voter)(bpname)(change) )
FC_REFLECT( besio::chain::tmp_claim, (voter)(bpname) )
FC_REFLECT( besio::chain::tmp_unfreeze, (voter)(bpname))

FC_REFLECT( besio::chain::controller::config,
            (actor_whitelist)
            (actor_blacklist)
            (contract_whitelist)
            (contract_blacklist)
