...
#include <besio/chain/block_timestamp.hpp>
#include <besio/chain/chain_config.hpp>
#include <besio/chain/producer_schedule.hpp>
#include <besio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(besio::chain::global_property_object, besio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(besio::chain::dynamic_global_property_object,
                         besio::chain::dynamic_global_property_multi_index)

FC_REFLECT(besio::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(besio::chain::global_property_object,
