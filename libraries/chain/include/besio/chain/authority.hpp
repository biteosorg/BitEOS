...
FC_REFLECT(besio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(besio::chain::key_weight, (key)(weight) )
FC_REFLECT(besio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(besio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(besio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
