...
FC_REFLECT( besio::chain::type_def                         , (new_type_name)(type) )
FC_REFLECT( besio::chain::field_def                        , (name)(type) )
FC_REFLECT( besio::chain::struct_def                       , (name)(base)(fields) )
FC_REFLECT( besio::chain::action_def                       , (name)(type)(ricardian_contract) )
FC_REFLECT( besio::chain::table_def                        , (name)(index_type)(key_names)(key_types)(type) )
FC_REFLECT( besio::chain::clause_pair                      , (id)(body) )
FC_REFLECT( besio::chain::error_message                    , (error_code)(error_msg) )
FC_REFLECT( besio::chain::abi_def                          , (version)(types)(structs)(actions)(tables)
