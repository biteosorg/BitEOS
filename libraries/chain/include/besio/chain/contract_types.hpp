...
using action_name    = besio::chain::action_name;
...
FC_REFLECT( besio::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( besio::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( besio::chain::setabi                           , (account)(abi) )
FC_REFLECT( besio::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( besio::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( besio::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( besio::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( besio::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( besio::chain::onerror                          , (sender_id)(sent_trx) )
