...
CHAINBASE_SET_INDEX_TYPE(besio::chain::permission_link_object, besio::chain::permission_link_index)

FC_REFLECT(besio::chain::permission_link_object, (id)(account)(code)(message_type)(required_permission))
