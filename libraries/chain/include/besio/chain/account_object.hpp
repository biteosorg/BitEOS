...
namespace besio { namespace chain {
   ...
   class account_object : public chainbase::object<account_object_type, account_object> {
      ...
      void set_abi( const besio::chain::abi_def& a ) {
...
CHAINBASE_SET_INDEX_TYPE(besio::chain::account_object, besio::chain::account_index)
CHAINBASE_SET_INDEX_TYPE(besio::chain::account_sequence_object, besio::chain::account_sequence_index)


FC_REFLECT(besio::chain::account_object, (name)(vm_type)(vm_version)(code_version)(code)(creation_date))
