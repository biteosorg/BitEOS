...
try:
    ...
    wallet=walletMgr.create(walletName, [cluster.besioAccount,cluster.defproduceraAccount,cluster.defproducerbAccount])
    if wallet is None:
    ...
    TestHelper.shutdown(cluster, walletMgr, testSuccessful, killBesInstances, killBesInstances, keepLogs, killAll, dumpErrorDetails)
