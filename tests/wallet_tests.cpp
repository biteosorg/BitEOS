...
#include <besio/utilities/rand.hpp>
...
{ try {
   ...
   constexpr auto key3 = "5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3"; // besio key
   ...
   // besio key is imported automatically when a wallet is created
